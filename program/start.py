...
@Client.on_message(
    command(["", f"@{BOT_USERNAME}"]) & filters.private & ~filters.edited
)
...
@Client.on_message(
    command(["пингa", f"пингa@{BOT_USERNAME}"]) & filters.group & ~filters.edited
)
...
@Client.on_message(command(["пинг", f"пинг@{BOT_USERNAME}"]) & ~filters.edited)
...
@Client.on_message(command(["пингs", f"пингs@{BOT_USERNAME}"]) & ~filters.edited)
@sudo_users_only
